...
const SEVERITY_COLORS = { critical: "#dc2626", high: "#ea580c", medium: "#d97706", low: "#65a30d", info: "#0ea5e9" };
            ...
            <ChartCard title="1. Daily Event Trend" span={2}>
              <ResponsiveContainer width="100%" height={280}>
                <AreaChart data={dailyData}>
                  ...
                  <YAxis />
                  <Tooltip />
                  <Area type="monotone" dataKey="events" stroke="#3b82f6" fill="#3b82f680" />
            ...
            <ChartCard title="4. Shift Compliance">
              <ResponsiveContainer width="100%" height={280}>
                <BarChart data={shiftData}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="shift" /><YAxis /><Tooltip /><Legend />
            ...
            <ChartCard title="7. Hourly Area">
              <ResponsiveContainer width="100%" height={280}>
                <AreaChart data={hourlyData}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="hour" tick={{ fontSize: 9 }} /><YAxis /><Tooltip />
          ...
          <>
            <ChartCard title="11. Shift Sessions">
              <ResponsiveContainer width="100%" height={280}>
                <BarChart data={shiftData}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="shift" /><YAxis /><Tooltip />
            ...
            <ChartCard title="18. Department Avg Risk">
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={departmentData}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="dept" tick={{ fontSize: 10 }} /><YAxis /><Tooltip />
            ...
            <ChartCard title="26. Anomaly Rate Over Time" span={2}>
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={dailyData.map(d => ({ ...d, rate: d.events > 0 ? (d.anomalies / d.events * 100).toFixed(1) : 0 }))}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="date" tick={{ fontSize: 10 }} /><YAxis unit="%" /><Tooltip />
